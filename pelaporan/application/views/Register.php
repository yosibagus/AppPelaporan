        ...
        <div class="container">
          <div class="row align-items-center justify-content-center p-100px-tb sm-p-60px-b">
            <div class="col-lg-5 md-p-30px-tb">
              <h1 class="font-alt white-color">Register</h1>
              <div class="subscribe-block">
                  <div class="card-block py-lg px-md">
                    <form id="loginForm" class="md-form form-light" role="form" action="<?= base_url(); ?>welcome/register_action" method="post">
                        
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="inputUser" class="form-label">Nama</label>
                            <div class="md-form-line-wrap">
                              <input id="inputUser" type="text" name="nama" placeholder="Nama" class="form-control" autofocus required autocomplete="off">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <div class="md-form-line-wrap">
                              <input id="inputPassword" type="email" name="email" placeholder="Email" class="form-control" required autocomplete="off">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <div class="md-form-line-wrap">
                              <input id="inputUser" type="text" name="username" placeholder="Username" class="form-control" required autocomplete="off">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <button type="submit" class="btn btn-block btn-light"><span class="btn-elem-wrap"><span class="text" style="color: darkblue">REGISTER</span></span></button>
                        </div>
                      </div>
                    </form>
                  </div>
                <label>Sudah punya akun? login <a href="<?= base_url(); ?>welcome">disini</a></label>
              </div>
            </div> 
